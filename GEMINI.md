# Goal
Create a JumperlessV5light to be used with an existing breadboard only on one side.
- Replace RP2050 with a Pico2
- Create variants with 1, 4 and all CH446Q
- Keep the wiring a subset of the current wiring as much as possible
